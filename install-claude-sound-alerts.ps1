...
$cliScript    = Join-Path $claudeDir 'claude-sounds.ps1'
...
if ($Uninstall) {
    ...
    if (Test-Path $cliScript) { Remove-Item $cliScript -Force }
...
# people already are. The same commands as the Unix `claude-sounds`.
$cliBody = @'
# =============================================================================
...
'@
Set-Content -Path $cliScript -Value $cliBody -Encoding utf8
Write-Ok "wrote claude-sounds.ps1"
